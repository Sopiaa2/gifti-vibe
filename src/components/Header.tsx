...
export default function Header({ remainingWantVotes, remainingBadVotes }: HeaderProps) {
  ...
  return (
    <header <header className="fixed top-[80px] left-0 right-0 z-50 max-w-[480px] mx-auto bg-card border-b border-border"> left-0 right-0 z-50 max-w-[480px] mx-auto bg-card border-b border-border">
